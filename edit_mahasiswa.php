...
if (isset($_GET['id'])) {
    ...
    // Kalo data ga ada, balik ke index
...
if (isset($_POST['update'])) {
    ...
    $update = "UPDATE mahasiswa 
               SET nama_mahasiswa='$nama', jurusan_id='$jurusan_id', umur_mahasiswa='$umur' 
...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-100 min-h-screen flex justify-center items-center p-8">
  ...
  <div class="bg-gray-800/90 backdrop-blur-lg border border-gray-700 rounded-2xl shadow-2xl w-full max-w-md p-8">
    ...
    <form method="POST" class="space-y-5">
      ...
      <div>
        ...
        <input type="text" name="nama_mahasiswa" value="<?= htmlspecialchars($data['nama_mahasiswa']); ?>" required
               class="w-full bg-gray-700 text-gray-100 border border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition">
      </div>
      ...
      <div>
        ...
        <input type="number" name="umur_mahasiswa" value="<?= htmlspecialchars($data['umur_mahasiswa']); ?>" required
               class="w-full bg-gray-700 text-gray-100 border border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition">
      </div>
